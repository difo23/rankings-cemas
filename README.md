...
## Kanban 
 Para aplicar la metodología ágil de kanban utilizamos Trello donde con su software de lista se pudo crear las historias de usuario que nos hizo más facíl la forma de organizarnos a distancia. Cada día los desarrolladores cuando terminan una tarea son enviadas a los Product Owners que son quienes deciden si ese aporte se complementa con la rama principal.
